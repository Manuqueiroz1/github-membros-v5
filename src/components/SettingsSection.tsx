                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col sm:flex-col items-center p-3 sm:p-4 rounded-lg border-2 transition-colors ${
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 w-full max-w-sm sm:max-w-md">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              <button
                ...
                className="flex-1 py-2 sm:py-3 text-sm sm:text-base text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex-1 bg-purple-600 text-white py-2 sm:py-3 text-sm sm:text-base rounded-lg hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Alterar Senha
              </button>
            </div>
