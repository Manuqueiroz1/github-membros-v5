    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
          <div>
            <h3 className="text-lg sm:text-xl lg:text-3xl font-bold mb-4">Converse com a Teacher Poli</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2 text-center">Acesse a Teacher Poli</h3>
        <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 text-center mb-6">Sua assistente de IA está esperando por você</p>
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Precisa de ajuda para acessar?</p>
          <a
            href="mailto:suporte@teacherpoli.com"
            className="inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
          >
