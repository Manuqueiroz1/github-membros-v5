...
export default function TeacherPoliSection() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      <div className="mb-8">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Teacher Poli</h2>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2 text-center">Acesse a Teacher Poli</h3>
        <p className="text-sm sm:text-base text-gray-600 text-center mb-6">Sua assistente de IA está esperando por você</p>
